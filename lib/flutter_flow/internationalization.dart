...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  // HomePage
  {
    'wu2rs2xg': {
      ...
      'ar': 'مسجل 24/7 365',
      'bn': '24/7 365 রেকর্ডার',
      'de': '24/7 365 Rekorder',
      'es': 'Grabador 24 horas al día, 7 días a la semana, 365 días al año',
      'fr': 'Enregistreur 24h/24, 7j/7, 365°',
      'hi': '24/7 365 रिकॉर्डर',
      'it': 'Registratore 365 24 ore su 24, 7 giorni su 7',
      'ja': '24時間365日レコーダー',
      'ko': '24/7 365 레코더',
      'pt': 'Gravador 365 24 horas por dia, 7 dias por semana',
      'ru': '24/7 365 Регистратор',
      'ur': '24/7 365 ریکارڈر',
      'zh_Hans': '24/7 365 录音机',
      'zh_Hant': '24/7 365 錄音機',
    },
    'cxfeoqs0': {
      'en': 'Month',
      'ar': 'شهر',
  ...
  // Miscellaneous
  {
    ...
    'ebj4odmj': {
      ...
      'ru':
          'Этому приложению требуется доступ Bluetooth для записи звука через устройство Bluetooth.',
      'ur':
